...
────────────────────────────────────────────────────────────── */
const g = globalThis;
// Tiny in-memory mirror as a safety net
...
export default async function handler(req, res) {
  ...
  // read-only follow status for client
  ...
  // MARK FOLLOW (per IP + platform) — accepts POST or GET; query or JSON
  if (
    ...
    // short lock to avoid double-fires from a single tap
  ...
  // spins reset version helpers (UI button)
